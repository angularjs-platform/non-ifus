...
const baseURL: string = '/org/ca/customer/user';
const baseState: string = 'app.ca.user-maintenance';
const parentState: string = null;
const abstractStateURL: string = null;
const abstractStateBreadCrumbLabel: string = null;
const formController: string = 'CACustomerUserProfileFormController';

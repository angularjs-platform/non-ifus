...
const baseURL: string = '/org/ca/customer/role';
const baseState: string = 'app.ca.role-maintenance';
const parentState: string = null;
const abstractStateURL: string = null;
const abstractStateBreadCrumbLabel: string = null;
const formController: string = 'CACustomerRoleFormController';
...
export class UiRouterConfig {
    ...
    private loadSecondaryMenu = (MenuService: IMenuService): any => {
        ...
        MenuService.setSecondaryMenuListID('ca-customer-maintenance-role-maintenance-ref');
    }
}

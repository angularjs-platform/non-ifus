...
var apiEndPoints = [
    ...
    {
        method: 'GET',
        url: '/organization/ca/customer/user/initiate',
        callback: initiateUser
    },
    {
        method: 'POST',
        url: '/organization/ca/customer/user/create',
        callback: sendSuccess
    },
    {
        method: 'GET',
        url: '/organization/ca/customer/user/edit/:id',
        callback: fetchUser
    },
    {
        method: 'GET',
        url: '/organization/ca/customer/user/view/:id',
        callback: fetchUser
    },
    {
        method: 'POST',
        url: '/organization/ca/customer/user/update',
        callback: sendSuccess
    },
    {
        method: 'POST',
        url: '/organization/ca/customer/user/delete',
        callback: sendSuccess
    }
];

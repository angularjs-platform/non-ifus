...
const baseURL: string = '/org/bga/bank/user';
const baseState: string = 'app.bga.bank-maintenance.user-maintenance';
...
const formController: string = 'BGABankUserProfileFormController';

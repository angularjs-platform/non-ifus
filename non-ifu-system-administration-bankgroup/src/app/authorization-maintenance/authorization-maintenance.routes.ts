...
const baseURL: string = '/org/bga/bankgroup/authorization';
const baseState: string = 'app.bga.authorization-maintenance';
const parentState: string = null;
const abstractStateURL: string = null;
const abstractStateBreadCrumbLabel: string = null;
const formController: string = 'BGABankGroupAuthorizationFormController';
...
export class UiRouterConfig {
    ...
    private loadSecondaryMenu = (MenuService: IMenuService): any => {
        ...
        MenuService.setSecondaryMenuListID('bga-bankgroup-maintenance-auth-matrix-maintenance-ref');
    }
}

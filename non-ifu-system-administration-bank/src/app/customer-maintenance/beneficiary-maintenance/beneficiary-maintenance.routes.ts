...
const baseURL: string = '/org/ba/customer/beneficiary';
const baseState: string = 'app.ba.customer-maintenance.beneficiary-maintenance';
...
const formController: string = 'BACustomerBeneficiaryFormController';

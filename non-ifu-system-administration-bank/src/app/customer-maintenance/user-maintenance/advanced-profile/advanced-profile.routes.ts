...
const baseURL: string = '/org/ba/customer/user/advanced';
const baseState: string = 'app.ba.customer-maintenance.user-maintenance.advanced';
const parentState: string = 'app.ba.customer-maintenance.user-maintenance';
...
const formController: string = 'BACustomerUserAdvancedProfileFormController';

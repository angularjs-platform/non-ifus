...
var apiEndPoints = [
    ...
    {
        method: 'GET',
        url: '/organization/ba/customer/user/initiate',
        callback: initiateUser
    },
    {
        method: 'POST',
        url: '/organization/ba/customer/user/create',
        callback: sendSuccess
    },
    {
        method: 'GET',
        url: '/organization/ba/customer/user/edit/:id',
        callback: fetchUser
    },
    {
        method: 'GET',
        url: '/organization/ba/customer/user/view/:id',
        callback: fetchUser
    },
    {
        method: 'POST',
        url: '/organization/ba/customer/user/update',
        callback: sendSuccess
    },
    {
        method: 'POST',
        url: '/organization/ba/customer/user/delete',
        callback: sendSuccess
    }
];

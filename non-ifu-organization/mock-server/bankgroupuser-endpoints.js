...
var apiEndPoints = [
    {
        method: 'GET',
        url: '/organization/bankgroup/user/list',
        callback: getUsers
    },
    {
        method: 'GET',
        url: '/organization/bankgroup/user/initiate',
        callback: initiateUser
    },
    {
        method: 'POST',
        url: '/organization/bankgroup/user/create',
        callback: sendSuccess
    },
    {
        method: 'GET',
        url: '/organization/bankgroup/user/edit/:id',
        callback: fetchUser
    },
    {
        method: 'GET',
        url: '/organization/bankgroup/user/view/:id',
        callback: fetchUser
    },
    {
        method: 'POST',
        url: '/organization/bankgroup/user/update',
        callback: sendSuccess
    },
    {
        method: 'POST',
        url: '/organization/bankgroup/user/delete',
        callback: sendSuccess
    }
];
